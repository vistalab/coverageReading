        ...
        for jj = 1:length(list_roiNames)
            ...
            if rmExists && roiExists
                ...
                for cc = 1:length(list_contours)
                    ...
                    ContourAndCoverage3D = ff_color_2Dinto3D_overlaid(RFcovContour, colorContour, RFcov3D);
                    
                    % ff_polarPlotFrom3DMatrix(rfcov, vfc)
                    ff_polarPlotFrom3DMatrix(ContourAndCoverage3D, vfc);
                                      
                    % title
                    titleName = {
                        'Contour with Coverage';
                        infoString; 
                        mfilename;
                        };
