...
H = hgload('~/Dropbox/TRANSFERIMAGES/Anteriorness and pRF size-lVOTRC. Thresh at co 0.05. All subjects-.fig')

% name things
xLabelString = 'MNI coordinate. posterior --> anterior';
yLabelString = 'pRF size (deg)'; 

titleName = {
    'Anteriorness and prf size. Heat map'
    'All subjects all voxels. Left VOTRC. Co thresh at 0.05'
    };
