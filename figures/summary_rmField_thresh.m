...
% may be overwritten
saveDescript = 'Words. Linear vs. CSS';
...
legend(list_rmNames)
titleName = [fieldToPlotDescript ' ' sumStatFuncDescript '. ' saveDescript]; 
...
if saveDropbox
   ...
   saveas(gcf, fullfile(dirDropbox, [titleName '.' saveExt]), saveExt);
