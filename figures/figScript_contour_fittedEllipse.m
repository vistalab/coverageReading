        ...
        for jj = 1:length(list_roiNames)
            ...
            if rmExists && roiExists
                ...
                for cc = 1:length(list_contours)
                    ...
                    % overlaidMat = ff_color_2Dinto3D(indicatorMat, trueColor, falseColor)
                    overlaidMat = ff_color_2Dinto3D(RFEllipseContour, colorEllipse, vfc.backgroundColor);
                    
                    % ff_polarPlotFrom3DMatrix(rfcov, vfc)
                    ff_polarPlotFrom3DMatrix(overlaidMat, vfc);
