...
% which distribution
% 1: sample with replacement numSamples voxels from each subject
% 2: take the median from each subject. In this case, specify numSamples to
% be 1
wDist = 2;
...
% save the median to the user data field in the .fig
set(gcf, 'UserData', ['Median: ' num2str(dataMedian)])
