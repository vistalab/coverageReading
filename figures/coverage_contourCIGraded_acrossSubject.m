    ...
    for kk = 1:numDts
       ...
       for cc = 1:length(list_contourLevels)
           ...
           RFmean = mean(allRFcov,3);
            ...
            titleName = {[roiNamePlot '. ' 'Group. Contour Level ' num2str(contourLevel) '. '] 
                [stimDescript '. n =' num2str(counter)] ...
                };
