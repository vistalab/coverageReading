...
BSAlpha = zeros(numSubs, numRois, numRms);
BSBeta  = zeros(numSubs, numRois, numRms);
...
%% standard error bars for the histogram bars
% standard error is over subjects for each eccentricity bin
for jj = 1:numRois
    for kk = 1:numRms
