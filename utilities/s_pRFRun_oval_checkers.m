% For some reason checker prfs are getting stuck??
% Perhaps specific to the subject (5) because subjects 1-4 worked
% Perhaps specific to the for loop. let's see what happens
