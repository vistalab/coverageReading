function ssCoords = ff_vol2talairachVolume(vw,skipTalFlag, coords)
% ssCoords = ff_vol2talairachVolume(vw,skipTalFlag, coords)
% IMPORTANT: MAKE SURE IN THE DIRECTORY WITH THE VW
% Original function: vol2talairachVolume
% which returned the ~average~ tal/mni coord of the ROI loaded in the view
% want all of it. so made own function where we can also input our own coords. rle feb 2018.
% 
% INPUTS:
% vw: the view
% skipTalFlag. 0 = talairach coords. 1 = mni coordinates
% coords. a numCoords x 3 voxel (IMPORTANT, this is usually transposed)
%
% ---------------------
...
% RL edit. 
% get the rmCoordsGet as opposed to the vw.ROIs.coords
