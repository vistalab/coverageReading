function [tSeriesCell, rfParamsCell, stimParamsCell, allNumVoxels] = ... 
    ff_tSeriesAndRfParamsCell(list_subInds, list_roiNames, list_dtNames, list_rmNames, varargin)
% [tSeriesCell, rfParamsCell, stimParamsCell, allNumVoxels] = ... 
%     ff_tSeriesAndRfParamsCell(list_subInds, list_roiNames, list_dtNames,
%     list_rmNames, varargin)
%
...
for ii = 1:numSubs
    ...
    for jj = 1:numRois
        ...
        for kk = 1:numRms
            ...
            stimParamsCell{ii,jj,kk} = params; 
