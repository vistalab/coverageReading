...
vfc.nboot           = 500;       % number of bootstraps
...
tem.saveFolderSingle = ['/biac4/wandell/data/reading_prf/forAnalysis/images/single/circles/' tem.saveFolderSub '/'];
tem.saveFolderGroup  = ['/biac4/wandell/data/reading_prf/forAnalysis/images/group/circles/' tem.saveFolderSub '/']; 
...
for jj = 1:length(tem.listRoi) %% looping over rois
    ...
    % save folder paths
    tem.saveFolderSingle = '/biac4/wandell/data/reading_prf/forAnalysis/images/single/circles/'; 
    tem.saveFolderGroup  = '/biac4/wandell/data/reading_prf/forAnalysis/images/group/circles/'; 
    ...
    if tem.YNthreshold
        ...
        for ii = 1:length(tem.subjectsToAnalyze)
            ...
            if tem.passesThreshold
                ...
                tem.figHandle = ff_pRFasCircles(RM_th{iisubRMth});
    ...
    switch tem.YNgroupAverage
        ...
        case 1
            ...
            if exist('RFcov','var')
                ...
                tem.handleEmpty = gcf; 
                title(['Group Average:' num2str(tem.groupName) tem.roi],'FontSize',24);
                saveas(tem.handleEmpty, [tem.saveFolderGroup, tem.roi '_' tem.groupName '_GroupAverage'  '.jpg'])
            end
