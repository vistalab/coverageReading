...
list_sessionPath = {
    ...
    '/biac4/wandell/biac3/wandell7/data/Words/vwfaLoc/jw/jw090311/'                 % jw
    '/biac4/wandell/data/reading_prf/karen/20140508_1319/'                          % kd
};
...
list_meshL = {
    ...
    'Left_Mesh_Smoothed_400.mat'        % jw
    'leftSmooth_400.mat'                % kd
    };
...
list_meshR = {
    ...
    'Right_Mesh_Smoothed400.mat'        % jw
    'rightSmooth_400.mat'               % kd
    };
...
list_meshPath = {
    ...
    '/biac4/wandell/data/anatomy/winawer/Anatomy20110308/'                      % jw
    '/biac4/wandell/data/anatomy/kduan/'                                        % kd
    };
...
list_retModName = {
     ...
     'rmImported_retModel_WideBar_HC.mat'                       % jw
     'retModel-20140917-134648-fFit.mat'                        % kd
    };
...
list_retModFolderPath = {
    ...
    [num2str(list_sessionPath{13}) 'Gray/GLMs/']            % jw
    [num2str(list_sessionPath{14}) 'Gray/BarsChecker/']     % kd
    };
...
%% roi local paths
list_roiLocalPath = cell(length(list_sessionPath),1); 

for ii = 1:length(list_sessionPath)
    
    list_roiLocalPath{ii} = [num2str(list_sessionPath{ii}) 'Gray/ROIs/'];   
