...
dirData = '/biac4/wandell/data/reading_prf/rosemary/20140818_1211/'; 
...
% this. 
listDirRois = {
    [dirRoiLocal 'leftVWFA']
    [dirRoiLocal 'rightVWFA']
    }; 
...
listDirRmModels = {
    [dirData 'Gray/AveragesBars/' 'retModel-20140824-011024-fFit.mat']
    }; 
