...
% Takes about 8 hours per subject -- using the old life repository
% 
% The encode version is run for subjects 8 onward
...
list_subInds = [ 8     9    13    15    17];  % 3     4     6     7    
...
for ii = list_subInds
    ...
    for cc = 1:length(list_conNames)
        ...
        % fe =
        % feSet(fe,'fit',feFitModel(feGet(fe,'model'),feGet(fe,'dsigdemeaned'),'bbnnls')); % older version
