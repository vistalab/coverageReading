...
list_yearIndsYAxis = [41, 75, 109, 143 ]; 
...
% find(strcmp('Passage Comprehension.1',testCode))
% find(strcmp('Passage Comprehension.2',testCode))
% find(strcmp('Passage Comprehension.3',testCode))
% find(strcmp('Passage Comprehension.4',testCode))
% 41, 75, 109, 143 
